...
router.delete("/deleteBranch/:id", [authenticateToken.validJWTNeeded, deleteBranch]);

router.post("/getStudentsByRoute", [authenticateToken.validJWTNeeded, getStudentsByRoute]);
...
router.delete("/deleteStudent/:id", [authenticateToken.validJWTNeeded, deleteStudent]);
...
router.delete("/deleteDriver/:id", [authenticateToken.validJWTNeeded, deleteDriver]);
...
router.delete("/deleteVehicle/:id", [authenticateToken.validJWTNeeded, deleteVehicle]);

router.get("/getAssignedDriverRoute/:id", [authenticateToken.validJWTNeeded, getAssignedDriverRoute]);
router.get("/getAssignedStudentRoute/:id", [authenticateToken.validJWTNeeded, getAssignedStudentRoute]);
router.post("/getRoute", [authenticateToken.validJWTNeeded, getRoute]);
router.get("/getAllRoutes/:branchId", [authenticateToken.validJWTNeeded, getAllRoutes]);
router.get("/getCurrentLocation/:id", [authenticateToken.validJWTNeeded, getCurrentLocation]);
router.get("/getAllVehicleInfo/:id", [authenticateToken.validJWTNeeded, getAllVehicleInfo]);
router.get("/getAllDrivers/:branchId", [authenticateToken.validJWTNeeded, getAllDrivers]);
router.post("/saveCurrentLocation", [authenticateToken.validJWTNeeded, saveCurrentLocation]);
router.post("/assignDriver", [authenticateToken.validJWTNeeded, assignDriver]);
router.put("/updateAssignedDriver", [authenticateToken.validJWTNeeded, updateAssignedDriver]);
